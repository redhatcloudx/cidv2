...
from cid.models import AwsImage, AzureImage, GoogleImage, Base
...
def import_google_data(images):
    ...
    for image in images:
        # Skip non-RHEL images
        if not image.get("family").startswith("rhel-"):
            continue
...
if __name__ == "__main__":
  ...
  parser.add_argument("file_path", help="The path to the JSON file containing the images")
